...
namespace Dirac.Infrastructure.Tests.Customer
{
    ...
    [CollectionDefinition("CustomerTests")]
    public class CustomerTestCollection : ICollectionFixture<CustomerTestFixture> { }
    public class CustomerTestFixture : IAsyncLifetime
    {
        ...
        public Task InitializeAsync()
        {
            ...
            serviceCollection.AddMicroserviceInfo(mi => mi.WithName("CustomerTest"));
