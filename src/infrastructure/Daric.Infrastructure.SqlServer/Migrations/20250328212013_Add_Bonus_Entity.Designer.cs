...
namespace Daric.Infrastructure.SqlServer.Migrations
{
    ...
    [Migration("20250328212013_Add_Bonus_Entity")]
    partial class Add_Bonus_Entity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.HasSequence("Account.AccountNumber")
                .StartsAt(1000000001L);

            modelBuilder.HasSequence("Account.TrackingCode")
                .StartsAt(1000L);

            modelBuilder.Entity("Daric.Domain.Accounts.Account", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Daric.Domain.Bonuses.Bonus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Daric.Domain.Transactions.Transaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Daric.Domain.Transactions.Transaction", b =>
                {
                    b.HasOne("Daric.Domain.Transactions.Transaction", "Parent")
                        .WithMany()
